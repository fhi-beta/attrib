...
One needs to give the fit, the dataset and the exposures with referance values. Est_mort will then using the sim function from the arm pachage to generate simulations of the underlying posterior distribution before using this to compute the estimated mortalities for each simulation. 
